...
- Erwarteter Wert einer Option: EV = Σ v_i*p_i -> wähle Option mit höchstem erwartetem Wert

- Kann zu Paradoxon geführt werden durch St. Petersburg-Spiel (Münzwurf, Menschen bieten wenig um
mitzuspielen)
...
Ward Edwarts 1954: SEU-Theorie (1 deskriptive Entscheidungstheorie vong Typ her)
...
Erklärungskonzept nach Hempel/Oppenheim (HO-Schema):
...
- Gibt Explanans
	...
	- Beispiel:
		...
		- G: Wenn Tank leer, springt ein Auto nicht an
		- A: Tank von MEINEM Auto ist leer
		- E: MEIN Auto springt nicht an
- 2 Probleme:
- Man geht davon aus, dass es soziologische Gesetze gibt (wie Naturgesetze) - gibt es bloß nicht
...
- Logik der Situation:
	...
	- Brückenhypothesen: wie Akteure ihre Situation einschätzen/von ihr beeinflusst werden
- Logik der Selektion:
	- wir brauchen Handlungstheorie(Regel, welche Handlungen Akteure unter Bedingungen ausführen)
	- muss geeignet sein für spezifischen Zweck
...
- Notation:
	...
	- P := zugehörige Wahrscheinlichkeitsverteilung
	- ∆(X)={(p_1 ,...,p_n ):p_i ≥0	and p_1	 +...+p n =1} (Lotterie)
	- x_1 ∼ x_2 : gleichermaßen präferiert
...
- Axoime:
	...
	- Monotonie
- Prinzip der Invarianz: Präferenzen dürfen nicht durch A.u.W. der Darst. der Konsequenzen und
  Alternativen beeinflusst werden
- Unabhängigkeit: Bild Folie 38

Sinn der Axiome:

- Gültigkeit der Erwartungsnutzentheorie
...
- verschiedene Akteurmodelle:
	- Homo Oeconomicus:
		- rational denkender Akteur, der Nutzen maximieren will
		- hat vollständige Informationen
		- Normen spielen als Vermeidung von Sanktionskosten eine Rolle
		- Problem: realitätsfremd
	- Ergänzung des Homo Oeconomicus: RREEMM:
		- erliegt Restriktionen und Erwartungen
...
- Attribute der Alternativen:
    - Bewertungskriterien werden sehr nach Erfahrung eingeschätzt
    - Attribute werden subjektiv wahrgenommen
    - Risiko/Wahrscheinlichkeit auch ein Attribut
    - Soziale Realität oft komplex
- Entscheidungsprozess
    - Kern der Entscheidungstheorie
    - Grundmodell ist flexibel
    - Hier: einfacher Entscheidungsprozess (siehe oben)

Entscheidungsregel: SEU

- Alternativen werden über den Parameter Nutzen verglichen
- (???)
- Urlaubs-Beispiel
...
- Pareto-Optimum: wenn ein Spieler um sich zu verbessern den anderen schlechter stellen müsste
...
- Chicken Game (Dilemma):
    ...
    - 2 pareto-optimale Nash-Gleichgewichte (???)
...
- Bayes' Rule
    ...
    - [Formel Seite 11]
- Experimente zeigen, dass Menschen Entscheidungsprozesse verkürzen und sind von Urteilsverzerrungen betroffen
- Jack und Linda: Vorurteile überwiegen den zugrundeliegenden statistischen Basisdaten
- SEU ist daher keine geeignete *deskriptive* Entscheidungstheorie
- sowas braucht man aber auch anscheinend gar ned
- Repräsentativheuristik:
    - Entscheidungsregel, in der die Wahrscheinlichkeit eines Ereignisses durch eine oder zwei Eigenschaften des Ereignisses geschätzt wird:
        ...
        - Beispiel: Linda und Jack
        - Beispiel: Geschlechterreihenfolge
- Verlustaversion und Framingeffekte führen zur fehlerhaften Berücksichtigung vergangener Investitionen für zukünftige Investitionen
    - Beispiel: Weinproblem
- Eigentlich gilt Prinzip der Invarianz, aber:
    - sprachliche Verpackung (framing) führt zu Präferenzbeeinflussung
    - Beispiele: Theaterkarten, Asian Disease
    - identische Erwartungswerte
    - warum?:
        - Risikosuche und -vermeidung (man präferiert sichere Alternative)
        
- Prospect Theory
    - moderne SEU-Theorie
    - Werte werden relativ zu einem situationsabhängigen Referenzpunkt beurteilt
    - Subjektive Werte und Wahrscheinlichkeiten folgen Funktionen mit bestimmten Charakteristika
    - Wertfunktion steiler im Verlust- als im Gewinnbereich
    - Beispiel Asian Disease:
        - Variante 1: 600 Menschen, die sterben können Referenzpunkt, Menschen, die gerettet werden können, Gewinne (Risikovermeidung)
        - Variante 2: 0 Menschen, die sterben können Referenzpunkt, Menschen, relativ dazu alles andere Verluste (Risikosuche)
    - Prospect Theory gibt den certainty effect
